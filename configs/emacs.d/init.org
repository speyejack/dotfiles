...
#+BEGIN_SRC emacs-lisp 
  (use-package centered-cursor-mode
    ...
    :defer 1
    :general
    (jag--visual-def "c" 'centered-cursor-mode)
    :config
...
Source: [[https://github.com/jordonbiondo/column-enforce-mode]]
 #+BEGIN_SRC emacs-lisp
   (use-package column-enforce-mode
     :defer 15
     :general
     (jag--visual-def "C" 'column-number-mode)
     :diminish
     :config
...
#+BEGIN_SRC emacs-lisp 
  (use-package diff-hl
    ...
    :defer 15
    :general
    (jag--visual-def "d" 'global-diff-hl-mode)
    :config
    (global-diff-hl-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp 
  (use-package golden-ratio
    :diminish
    :general
    (jag--visual-def "g" 'golden-ratio-mode)
    :config
...
#+BEGIN_SRC emacs-lisp 
  (use-package highlight-numbers
    ...
    :diminish
    :general
    (jag--visual-def "n" 'highlight-numbers-mode)
    :config
...
#+BEGIN_SRC emacs-lisp 
  (use-package highlight-parentheses
    ...
    :defer 5
    :general
    (jag--visual-def "p" 'highlight-parentheses-mode)
    :config
...
#+BEGIN_SRC emacs-lisp 
  (use-package highlight-symbol
    ...
    :defer 15
    :general
    (jag--visual-def "n" 'auto-highlight-symbol-mode)
    :config
    (add-hook 'prog-mode-hook 'auto-highlight-symbol-mode))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp 
  (use-package imenu-list
    :general
    (jag--visual-def "i" 'imenu-list-smart-toggle)
    :diminish)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp 
  (use-package nlinum-relative
    :defer 15
    :general
    (jag--visual-def "n" 'nlinum-relative-mode)
    :diminish
    :config
...
#+BEGIN_SRC emacs-lisp 
  (use-package rainbow-delimiters
    :general
    (jag--visual-def "r" 'rainbow-delimiters-mode)
    :diminish)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp 
  (use-package volatile-highlights
    ...
    :defer 5
    :general
    (jag--visual-def "v" 'volatile-highlights-mode)
    :config
